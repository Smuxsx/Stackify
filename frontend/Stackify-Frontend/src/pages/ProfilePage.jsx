...
import { PlusIcon, PackageIcon, EyeIcon, EditIcon, Trash2Icon, Plus } from "lucide-react"
            ...
            <div key={product.id} className="card card-side bg-base-300">
              ...
              <div className="card-body p-4">
                ...
                <div className="card-actions justify-end mt-2">
                  ...
                  <button onClick={() => navigate(`/edit/${product.id}`)} className="btn btn-ghost btn-sm gap-1">
                    <EditIcon className="size-3"/> Edit
                  </button>
                  <button onClick={() => handleDelete(product.id)} className="btn btn-ghost text-error btn-sm gap-1">
