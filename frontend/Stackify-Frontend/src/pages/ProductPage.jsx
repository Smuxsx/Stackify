...
function ProductPage() {
  ...
  if (error || !product) {
    return (
      <div className='card bg-base-300 max-w-d mx-auto'>
                ...
                <div className='divider my-3'>
                  <div className='flex items-center gap-3'>
                    <div className='avatar'>
                      <div className='w-12 rounded-full ring ring-primary ring-offset-base-100 ring-offset-2'><img src={product.user.imageUrl}/></div>
                    </div>
                  </div>
                  <div>
